...
/**
 * This class represents a Matrix. It contains methods to add data elements
 * to the matrix. To construct the object it needs the number of row/columns.
 * 
 * The matrix will hold double values in it's elements.
 */
public class MatrixArrayImpl implements IMatrix {
     ...
     */
    public MatrixArrayImpl(int numberOfColumns, int numberOfRows)
    {
